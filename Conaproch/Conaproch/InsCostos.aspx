...
<body data-spy="scroll" data-target=".navbar" onload="contadorDias()">
    <header id="header">
        ...
        <nav >
            ...
            <li><a class="nav-li-active" href="InsCostos.aspx"><div style="padding-top:9px;"><small>INSCRIPCIONES Y REGISTRO</small></div></a></li>
    ...
    <!-- end navbar -->
     ...
     <div id="about-us" class="section">
        <div class="container">
            <div class="hero">
                <h1>Datos para depósito</h1>
                <p>Consejo Nacional de Productores de Chiles S.C. </p>
            </div>
            <div class="row">
                <div class="span6">
                ...
                <div class="span6">
                    <h3>Banco: BBV Bancomer </h3>
                        CUENTA:
                    <div class="progress">
                        <div class="bar" data-width="60"><span>0169937854</span></div>
                    </div>
                    CLABE:
                    <div class="progress">
                        <div class="bar" data-width="80"><span>012016001699378548 </span></div>
                    </div>
                </div>
            </div>
            <br /><br />
