        ...
        <div class="container">
            ...
            <div id="modalbox" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-body">
                    ...
                    <h3>
                        Argo project title living room</h3>
                    <p>
                        Maecenas lectus tellus, faucibus id auctor vitae, egestas nec turpis. Proin accumsan
                        interdum lacus nec convallis. Sed vestibulum placerat auctor.
                    </p>
                </div>
                    ...
                    <div class="carousel-inner">
                        <div class="active item">
                            ...
                            <div class="msg">
                                ...
                                <p>
                                    "ARGO did a great job with the layout of our website. It is easy to navigate and
                                    has a clean, modern appearance. Feedback was encouraged throughout the process,
                                    and emails were always answered in a timely .
                                    <br>
                                    We are very proud of our new website. It has much improved functionality and metrics.
                                    ARGO worked to make sure that we were happy with the end product."</p>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="msg">
                                ...
                                <p>
                                    " It is easy to navigate and has a clean, modern appearance. Feedback was encouraged
                                    throughout the process, and emails were always answered in a timely."</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="hero">
                <h1>
                    about us</h1>
                <p>
                    Argo Theme is awesome with clean, elegant design and easily to customize</p>
            </div>
            <div class="row">
                <div class="span6">
                    <h3>
            ...
            <div class="our-team row">
                <div class="span6">
                    <div class="team">
                        ...
                        <div class="info">
                            <h4 class="name">
                                Peter L.Marcus<small> - architect</small></h4>
                            <p>
                ...
                <div class="row-full clearfix">
                    <div class="brick1">
                        <a href="http://errors.stablehost.com/406.php" class="article">
                            ...
                            <div class="meta">
                                <h5>
                                    <i class="icon-file-alt"></i>veniam, quis nostrud ARGO beautiful form ever</h5>
                                <p class="desc">
                                    Maecenas lectus tellus, faucibus id auctor vitae, egestas nec turpis. Proin accumsan
                                    interdum lacus nec convallis. Sed vestibulum placerat auctor.
                                </p>
